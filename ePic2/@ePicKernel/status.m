...
%       'ledR'            :   get led R value
%       'ledG'            :   get led G value
%       'ledB'            :   get led B value
...
% Access to ePic values
    ...
    case 'ledR'
        stat = ePic.update.ledR;
        up = ePic.updated.ledR;
    case 'ledG'
        stat = ePic.update.ledG;
        up = ePic.updated.ledG;
    case 'ledB'
        stat = ePic.update.ledB;
        up = ePic.updated.ledB;
